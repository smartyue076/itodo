...
![创建计划](docs/img/create_plan.png)

---

### 5. 周复盘

周复盘视图用于沉淀一周任务执行情况，帮助用户从计划进入总结。
...
复盘内容基于 Review（复盘）数据模型保存，便于后续统计分析。

![周复盘视图](docs/img/weekly_review.png)

---

### 6. 复盘分享图

复盘完成后，可以将本周总结生成适合分享的图片，用于归档、展示或发送给他人。

![周复盘分享](docs/img/weekly_review_share.png)
